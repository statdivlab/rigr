...
# Linear Regression
As a first example, we run a linear regression analysis of atrophy on age and male, from the `mri` data. This dataset is included in the `rigr` package, and its documentation can be found on Scott Emerson's website [here](http://www.emersonstatistics.com/datasets/mri.pdf).
